 ...
 * JS에서의 배열
 * 배열요소의 타입이 고정이 아니다
 *      서로 다른 type의 요소를 1개의 같은 배열에 저장할 수 있다
 */
// JS 에서 배열 만들기
// blank 배열
let 배열1 = [];
...
// 마지막에 return이 true인 경우만 해당 요소를 다른 배열에 push
// (return값이 저장되는 게 아니라 return값이 true일 때 '요소'의 값이 저장되는것)

// return문이 true일 때 해당하는 요소값이 짝수 배열에 push된다
